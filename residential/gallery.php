...
<body style="margin: 0px; padding: 0px; font-family:Arial, Verdana;background-color:#fff;">
    ...
    <style> 
        ...
        .bricon
        {
            background: url(/gallery/browser-icons.png);
        }
		div {
			cursor:pointer;	
		}
    ...
    <script type="text/javascript" src="/gallery/jssor.core.js"></script>
    <script type="text/javascript" src="/gallery/jssor.utils.js"></script>
    <script type="text/javascript" src="/gallery/jssor.slider.js"></script>
    <script>
...
$password = 'UofL2013!';
 $conn = mysql_connect($dbpath, $username, $password);
            ...
            $sql=mysql_query("SELECT * FROM slider_images WHERE active = 1 AND filename NOT LIKE 'Home%' GROUP BY filename");
			while($row=mysql_fetch_assoc($sql)){
            ?>
            <div>
                <img u="image" src="slider/images/<?php echo $row['filename'];?>.jpg" />
                <img u="thumb" src="slider/images/<?php echo $row['filename'];?>.jpg" />
            </div>
            <?php
			}
			?>
        ...
        <style>
            ...
            */
            .jssora05l, .jssora05r, .jssora05ldn, .jssora05rdn
            {
            	...
            	cursor: pointer;
            	display: block;
                background: url(/gallery/a17.png) no-repeat;
                overflow:hidden;
            }
        ...
        <div u="thumbnavigator" class="jssort02" style="position: absolute; width: 240px; height: 480px; left:0px; bottom: 0px;">
            ...
            <style>
                ...
                */
                ...
                {
                	background: url(/gallery/t01.png) center center;
                	border-width: 0px;
                    top: 2px;
                    left: 2px;
                    width: 95px;
